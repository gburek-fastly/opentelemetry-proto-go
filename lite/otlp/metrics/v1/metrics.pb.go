...
// MarshalProtoJSON marshals the HistogramDataPoint message to JSON.
func (x *HistogramDataPoint) MarshalProtoJSON(s *json.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
	...
	if len(x.ExplicitBounds) > 0 || s.HasField("explicitBounds") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("explicitBounds")
		s.WriteFloat64Array(x.ExplicitBounds)
	}
	if len(x.Exemplars) > 0 || s.HasField("exemplars") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("exemplars")
...
// MarshalJSON marshals the HistogramDataPoint to JSON.
func (x *HistogramDataPoint) MarshalJSON() ([]byte, error) {
	return json.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the HistogramDataPoint message from JSON.
func (x *HistogramDataPoint) UnmarshalProtoJSON(s *json.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
		...
		case "explicit_bounds", "explicitBounds":
			s.AddField("explicit_bounds")
			if s.ReadNil() {
				x.ExplicitBounds = nil
				return
			}
			x.ExplicitBounds = s.ReadFloat64Array()
		case "exemplars":
			s.AddField("exemplars")
			if s.ReadNil() {
				x.Exemplars = nil
...
// UnmarshalJSON unmarshals the HistogramDataPoint from JSON.
func (x *HistogramDataPoint) UnmarshalJSON(b []byte) error {
	return json.DefaultUnmarshalerConfig.Unmarshal(b, x)
}
...
// MarshalProtoJSON marshals the ExponentialHistogramDataPoint message to JSON.
func (x *ExponentialHistogramDataPoint) MarshalProtoJSON(s *json.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
	...
	if x.Scale != 0 || s.HasField("scale") {
		...
		s.WriteInt32(x.Scale)
	}
	if x.ZeroCount != 0 || s.HasField("zeroCount") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("zeroCount")
		s.WriteUint64(x.ZeroCount)
	}
	if x.Positive != nil || s.HasField("positive") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("positive")
		x.Positive.MarshalProtoJSON(s.WithField("positive"))
	}
	if x.Negative != nil || s.HasField("negative") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("negative")
		x.Negative.MarshalProtoJSON(s.WithField("negative"))
	}
	if x.Flags != 0 || s.HasField("flags") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("flags")
	...
	if x.ZeroThreshold != 0 || s.HasField("zeroThreshold") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("zeroThreshold")
		s.WriteFloat64(x.ZeroThreshold)
	}
	s.WriteObjectEnd()
}

// MarshalJSON marshals the ExponentialHistogramDataPoint to JSON.
func (x *ExponentialHistogramDataPoint) MarshalJSON() ([]byte, error) {
	return json.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the ExponentialHistogramDataPoint message from JSON.
func (x *ExponentialHistogramDataPoint) UnmarshalProtoJSON(s *json.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
		...
		case "zero_count", "zeroCount":
			s.AddField("zero_count")
			x.ZeroCount = s.ReadUint64()
		case "positive":
			if s.ReadNil() {
				x.Positive = nil
				return
			}
			x.Positive = &ExponentialHistogramDataPoint_Buckets{}
			x.Positive.UnmarshalProtoJSON(s.WithField("positive", true))
		case "negative":
			if s.ReadNil() {
				x.Negative = nil
				return
			}
			x.Negative = &ExponentialHistogramDataPoint_Buckets{}
			x.Negative.UnmarshalProtoJSON(s.WithField("negative", true))
		case "flags":
			s.AddField("flags")
			x.Flags = s.ReadUint32()
		case "exemplars":
...
// UnmarshalJSON unmarshals the ExponentialHistogramDataPoint from JSON.
func (x *ExponentialHistogramDataPoint) UnmarshalJSON(b []byte) error {
	return json.DefaultUnmarshalerConfig.Unmarshal(b, x)
}
