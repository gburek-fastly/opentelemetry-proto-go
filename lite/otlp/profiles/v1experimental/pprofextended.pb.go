...
func (m *Profile) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.AttributeTable) > 0 {
		for iNdEx := len(m.AttributeTable) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.AttributeTable[iNdEx].MarshalToSizedBufferVTStrict(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (x BuildIdKind) MarshalProtoText() string {
	return x.String()
}
func (x *Profile) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("Profile {")
	if len(x.SampleType) > 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("sample_type: [")
	...
	if len(x.StringTable) > 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("string_table: [")
		for i, v := range x.StringTable {
			if i > 0 {
				sb.WriteString(", ")
			}
	...
	if x.DropFrames != 0 {
		...
		sb.WriteString("drop_frames: ")
		sb.WriteString(strconv.FormatInt(int64(x.DropFrames), 10))
	}
	if x.KeepFrames != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("keep_frames: ")
		sb.WriteString(strconv.FormatInt(int64(x.KeepFrames), 10))
	}
	if x.TimeNanos != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("time_nanos: ")
		sb.WriteString(strconv.FormatInt(int64(x.TimeNanos), 10))
	}
	if x.DurationNanos != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("duration_nanos: ")
		sb.WriteString(strconv.FormatInt(int64(x.DurationNanos), 10))
	}
	if x.PeriodType != nil {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("period_type: ")
		sb.WriteString(x.PeriodType.MarshalProtoText())
	}
	if x.Period != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		...
		sb.WriteString(strconv.FormatInt(int64(x.Period), 10))
	}
	if len(x.Comment) > 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
	...
	if x.DefaultSampleType != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("default_sample_type: ")
		sb.WriteString(strconv.FormatInt(int64(x.DefaultSampleType), 10))
	}
	if len(x.LocationIndices) > 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("location_indices: [")
		for i, v := range x.LocationIndices {
			if i > 0 {
				sb.WriteString(", ")
			}
			sb.WriteString(strconv.FormatInt(int64(v), 10))
	...
	if len(x.AttributeTable) > 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("attribute_table: [")
		for i, v := range x.AttributeTable {
			if i > 0 {
				sb.WriteString(", ")
			}
			sb.WriteString(v.MarshalProtoText())
	...
	if len(x.AttributeUnits) > 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("attribute_units: [")
		for i, v := range x.AttributeUnits {
			if i > 0 {
				sb.WriteString(", ")
			}
			sb.WriteString(v.MarshalProtoText())
	...
	if len(x.LinkTable) > 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("link_table: [")
		for i, v := range x.LinkTable {
			if i > 0 {
				sb.WriteString(", ")
			}
			sb.WriteString(v.MarshalProtoText())
...
func (x *AttributeUnit) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("AttributeUnit {")
	if x.AttributeKey != 0 {
		if sb.Len() > 15 {
			sb.WriteString(" ")
		}
		sb.WriteString("attribute_key: ")
		sb.WriteString(strconv.FormatInt(int64(x.AttributeKey), 10))
	}
	if x.Unit != 0 {
		if sb.Len() > 15 {
			sb.WriteString(" ")
		...
		sb.WriteString("unit: ")
		sb.WriteString(strconv.FormatInt(int64(x.Unit), 10))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *Link) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("Link {")
	if x.TraceId != nil {
		if sb.Len() > 6 {
...
func (x *Sample) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("Sample {")
	if len(x.LocationIndex) > 0 {
		if sb.Len() > 8 {
			sb.WriteString(" ")
		}
		sb.WriteString("location_index: [")
		for i, v := range x.LocationIndex {
			if i > 0 {
				sb.WriteString(", ")
			}
	...
	if x.LocationsStartIndex != 0 {
		if sb.Len() > 8 {
			sb.WriteString(" ")
		}
		sb.WriteString("locations_start_index: ")
		sb.WriteString(strconv.FormatUint(uint64(x.LocationsStartIndex), 10))
	}
	if x.LocationsLength != 0 {
		if sb.Len() > 8 {
			sb.WriteString(" ")
		}
		sb.WriteString("locations_length: ")
		sb.WriteString(strconv.FormatUint(uint64(x.LocationsLength), 10))
	}
	if x.StacktraceIdIndex != 0 {
		if sb.Len() > 8 {
			sb.WriteString(" ")
		}
		sb.WriteString("stacktrace_id_index: ")
		sb.WriteString(strconv.FormatUint(uint64(x.StacktraceIdIndex), 10))
	}
	...
	if x.Link != 0 {
		...
		sb.WriteString("link: ")
		sb.WriteString(strconv.FormatUint(uint64(x.Link), 10))
	}
	if len(x.TimestampsUnixNano) > 0 {
		if sb.Len() > 8 {
			sb.WriteString(" ")
		}
		sb.WriteString("timestamps_unix_nano: [")
		for i, v := range x.TimestampsUnixNano {
			if i > 0 {
				sb.WriteString(", ")
			}
			sb.WriteString(strconv.FormatUint(uint64(v), 10))
...
func (x *Label) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("Label {")
	if x.Key != 0 {
		if sb.Len() > 7 {
	...
	if x.Str != 0 {
		...
		sb.WriteString("str: ")
		sb.WriteString(strconv.FormatInt(int64(x.Str), 10))
	}
	if x.Num != 0 {
		if sb.Len() > 7 {
			sb.WriteString(" ")
		...
		sb.WriteString("num: ")
		sb.WriteString(strconv.FormatInt(int64(x.Num), 10))
	}
	if x.NumUnit != 0 {
		if sb.Len() > 7 {
			sb.WriteString(" ")
		}
		sb.WriteString("num_unit: ")
		sb.WriteString(strconv.FormatInt(int64(x.NumUnit), 10))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *Mapping) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("Mapping {")
	if x.Id != 0 {
		if sb.Len() > 9 {
	...
	if x.MemoryStart != 0 {
		...
		sb.WriteString("memory_start: ")
		sb.WriteString(strconv.FormatUint(uint64(x.MemoryStart), 10))
	}
	if x.MemoryLimit != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("memory_limit: ")
		sb.WriteString(strconv.FormatUint(uint64(x.MemoryLimit), 10))
	}
	if x.FileOffset != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("file_offset: ")
		sb.WriteString(strconv.FormatUint(uint64(x.FileOffset), 10))
	}
	if x.Filename != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		...
		sb.WriteString(strconv.FormatInt(int64(x.Filename), 10))
	}
	if x.BuildId != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		...
		sb.WriteString(strconv.FormatInt(int64(x.BuildId), 10))
	}
	if x.HasFunctions != false {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("has_functions: ")
		sb.WriteString(strconv.FormatBool(x.HasFunctions))
	}
	if x.HasFilenames != false {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("has_filenames: ")
		sb.WriteString(strconv.FormatBool(x.HasFilenames))
	}
	if x.HasLineNumbers != false {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("has_line_numbers: ")
		sb.WriteString(strconv.FormatBool(x.HasLineNumbers))
	}
	if x.HasInlineFrames != false {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("has_inline_frames: ")
		sb.WriteString(strconv.FormatBool(x.HasInlineFrames))
	}
	if x.BuildIdKind != 0 {
		if sb.Len() > 9 {
			sb.WriteString(" ")
		}
		sb.WriteString("build_id_kind: ")
		sb.WriteString("\"")
		sb.WriteString(BuildIdKind(x.BuildIdKind).String())
		sb.WriteString("\"")
	}
	if len(x.Attributes) > 0 {
		if sb.Len() > 9 {
...
func (x *Location) MarshalProtoText() string {
	...
	if x.MappingIndex != 0 {
		...
		sb.WriteString("mapping_index: ")
		sb.WriteString(strconv.FormatUint(uint64(x.MappingIndex), 10))
	}
	if x.Address != 0 {
		if sb.Len() > 10 {
			sb.WriteString(" ")
		...
		sb.WriteString(strconv.FormatUint(uint64(x.Address), 10))
	}
	if len(x.Line) > 0 {
		if sb.Len() > 10 {
			sb.WriteString(" ")
	...
	if x.IsFolded != false {
		...
		sb.WriteString("is_folded: ")
		sb.WriteString(strconv.FormatBool(x.IsFolded))
	}
	if x.TypeIndex != 0 {
		if sb.Len() > 10 {
			sb.WriteString(" ")
		}
		sb.WriteString("type_index: ")
		sb.WriteString(strconv.FormatUint(uint64(x.TypeIndex), 10))
	}
	if len(x.Attributes) > 0 {
		if sb.Len() > 10 {
			sb.WriteString(" ")
...
func (x *Line) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("Line {")
	if x.FunctionIndex != 0 {
		if sb.Len() > 6 {
			sb.WriteString(" ")
		}
		sb.WriteString("function_index: ")
		sb.WriteString(strconv.FormatUint(uint64(x.FunctionIndex), 10))
	}
	if x.Line != 0 {
		if sb.Len() > 6 {
			sb.WriteString(" ")
	...
	if x.Column != 0 {
		...
		sb.WriteString(strconv.FormatInt(int64(x.Column), 10))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *Function) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("Function {")
	if x.Id != 0 {
		if sb.Len() > 10 {
	...
	if x.Name != 0 {
		...
		sb.WriteString("name: ")
		sb.WriteString(strconv.FormatInt(int64(x.Name), 10))
	}
	if x.SystemName != 0 {
		if sb.Len() > 10 {
			sb.WriteString(" ")
		}
		sb.WriteString("system_name: ")
		sb.WriteString(strconv.FormatInt(int64(x.SystemName), 10))
	}
	if x.Filename != 0 {
		if sb.Len() > 10 {
			sb.WriteString(" ")
	...
	if x.StartLine != 0 {
		...
		sb.WriteString(strconv.FormatInt(int64(x.StartLine), 10))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (m *Profile) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			m.AttributeTable = append(m.AttributeTable, &v1.KeyValue{})
			if err := m.AttributeTable[len(m.AttributeTable)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 17:
