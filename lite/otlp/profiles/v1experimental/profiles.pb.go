...
func (m *ProfileContainer) CloneMessageVT() protobuf_go_lite.CloneMessage {
	return m.CloneVT()
}
...
func (this *ProfileContainer) EqualMessageVT(thatMsg any) bool {
...
func (x *ProfilesData) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ProfilesData {")
	if len(x.ResourceProfiles) > 0 {
		if sb.Len() > 14 {
			sb.WriteString(" ")
		}
		sb.WriteString("resource_profiles: [")
		for i, v := range x.ResourceProfiles {
			if i > 0 {
				sb.WriteString(", ")
			}
...
func (x *ResourceProfiles) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ResourceProfiles {")
	if x.Resource != nil {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
	...
	if len(x.ScopeProfiles) > 0 {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
		sb.WriteString("scope_profiles: [")
		for i, v := range x.ScopeProfiles {
			if i > 0 {
				sb.WriteString(", ")
			}
			sb.WriteString(v.MarshalProtoText())
...
func (x *ScopeProfiles) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ScopeProfiles {")
	if x.Scope != nil {
		if sb.Len() > 15 {
			sb.WriteString(" ")
		}
...
func (x *ProfileContainer) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ProfileContainer {")
	if x.ProfileId != nil {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
		...
		sb.WriteString("\"")
		sb.WriteString(base64.StdEncoding.EncodeToString(x.ProfileId))
		sb.WriteString("\"")
	}
	...
	if x.OriginalPayloadFormat != "" {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
		sb.WriteString("original_payload_format: ")
		sb.WriteString(strconv.Quote(x.OriginalPayloadFormat))
	}
	if x.OriginalPayload != nil {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
		sb.WriteString("original_payload: ")
		sb.WriteString("\"")
		sb.WriteString(base64.StdEncoding.EncodeToString(x.OriginalPayload))
		sb.WriteString("\"")
	}
	if x.Profile != nil {
		if sb.Len() > 18 {
