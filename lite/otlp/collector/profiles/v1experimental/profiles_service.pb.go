...
func (x *ExportProfilesServiceRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportProfilesServiceRequest {")
...
func (x *ExportProfilesServiceResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportProfilesServiceResponse {")
...
func (x *ExportProfilesPartialSuccess) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportProfilesPartialSuccess {")
	if x.RejectedProfiles != 0 {
		if sb.Len() > 30 {
			sb.WriteString(" ")
		}
		sb.WriteString("rejected_profiles: ")
		sb.WriteString(strconv.FormatInt(int64(x.RejectedProfiles), 10))
	}
	if x.ErrorMessage != "" {
		if sb.Len() > 30 {
			sb.WriteString(" ")
