...
func (x *ExportTraceServiceRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportTraceServiceRequest {")
...
func (x *ExportTraceServiceResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportTraceServiceResponse {")
	if x.PartialSuccess != nil {
		if sb.Len() > 28 {
			sb.WriteString(" ")
		}
		sb.WriteString("partial_success: ")
		sb.WriteString(x.PartialSuccess.MarshalProtoText())
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *ExportTracePartialSuccess) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportTracePartialSuccess {")
	if x.RejectedSpans != 0 {
		if sb.Len() > 27 {
			sb.WriteString(" ")
		}
		sb.WriteString("rejected_spans: ")
		sb.WriteString(strconv.FormatInt(int64(x.RejectedSpans), 10))
	}
	if x.ErrorMessage != "" {
		if sb.Len() > 27 {
			sb.WriteString(" ")
