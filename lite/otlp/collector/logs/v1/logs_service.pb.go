...
func (x *ExportLogsServiceRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportLogsServiceRequest {")
...
func (x *ExportLogsServiceResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportLogsServiceResponse {")
...
func (x *ExportLogsPartialSuccess) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportLogsPartialSuccess {")
	if x.RejectedLogRecords != 0 {
		if sb.Len() > 26 {
			sb.WriteString(" ")
		}
		sb.WriteString("rejected_log_records: ")
		sb.WriteString(strconv.FormatInt(int64(x.RejectedLogRecords), 10))
	}
	if x.ErrorMessage != "" {
		if sb.Len() > 26 {
			sb.WriteString(" ")
