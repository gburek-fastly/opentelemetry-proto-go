...
func (x *ExportMetricsServiceRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportMetricsServiceRequest {")
...
func (x *ExportMetricsServiceResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportMetricsServiceResponse {")
...
func (x *ExportMetricsPartialSuccess) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ExportMetricsPartialSuccess {")
	if x.RejectedDataPoints != 0 {
		if sb.Len() > 29 {
			sb.WriteString(" ")
		}
		sb.WriteString("rejected_data_points: ")
		sb.WriteString(strconv.FormatInt(int64(x.RejectedDataPoints), 10))
	}
	if x.ErrorMessage != "" {
		if sb.Len() > 29 {
			sb.WriteString(" ")
